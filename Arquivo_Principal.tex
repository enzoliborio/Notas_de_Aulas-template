...
\begin{document}
	...
	% ---- RESUMO e PREFÁCIO ----
	\include{Pre_textual/Resumo.tex}
	\include{Pre_textual/Prefacio.tex}
	...
	% ---- CAPÍTULOS ----
    \include{Capítulos/00_Introducao_ao_template.tex} % apague essa linha
